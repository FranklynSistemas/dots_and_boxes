    ...
    var dibujarLineas = function()
    {
        ...
        for(var i = 0; i < numLineas; i++)
        {
            ...
            for(var c = 0; c < numLineas; c++)
            {
                ...
                {
                    context.fillStyle = matrixDots[i][c].jugador === 1 ? "#359CBC" : "#E07E53";
        ...
        for(var i = 0; i < lineasJuego.length; i++)
        {
            if(lineasJuego[i].usado)
            {
                ...
                //context.shadowColor = "black";
                context.lineWidth = 10;
                context.strokeStyle = lineasJuego[i].jugador === 1 ? "#3CAFD9" : "#F99762";
                context.stroke();
            }
        }
